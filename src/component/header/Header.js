...
import {fetchInfoPark} from "../../redux/infoCinemaSlice";
...
const Header = () => {
    ...
    useEffect(() => {
        dispatch(fetchInfoPark())
    }, [])

    return (
        <div>
            <div className="collapse" id="navbarToggleExternalContent">
                <div className="bgACord p-4">
                    <div className="search menu_header ">
                        {
                            stateInfoPark.map(item => {
                                return <div key={item.id}>
                                    ...
                                    <p> <a href={`tel:${item.phone_number}`}>{item.phone_number}</a> </p>
                                </div>
                            })
                        }
                    </div>
            ...
            <nav className="navbar navbar-dark header__header_cinema">
                <div className="container_glob">
                    <div className="logo">
                        <img src={logo} alt="logo"/>
                    </div>

                    <div className="search blockHeder">
                        {
                            stateInfoPark.map(item => {
                                return <div key={item.id}>
                                    <p>
                    ...
                    <button className="navbar-toggler dnone" type="button" data-bs-toggle="collapse"
